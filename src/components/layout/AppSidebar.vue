...
const menuConfig = [
  ...
  },
  {
    ...
    permissions: null,
    children: [
      { label: 'Contabilidad', route: '/contabilidad' },
      { label: 'Saldos', route: '/contabilidad/saldos' }
    ]
  }
]
        ...
        >
          ...
          >
            <span class="nav-icon">
              ...
              <!-- Accounting Icon -->
              <svg v-if="item.icon === 'accounting'" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
